...
export default function Home() {
  ...
  return (
    <div className="bg-black">
      ...
      {/* Footer */}
      <footer className="border-gray-700 sm:grid sm:grid-cols-2 border-t-[1px] sm:p-20 p-10">
            ...
            {iconNames.map((icon) => {
              return (
                <div className="p-1 flex hover:bg-white transition duration-300 justify-center bg-gray-500 rounded-full items-center">
                  <i className={`bx bxl-${icon} text-black`}></i>
                </div>
              );
            })}
          </div>
        ...
        <div className="grid grid-cols-2">
          <div className="">
            <ul>
              ...
              {firstList.map((item) => {
                return (
                  <li className="text-gray-500 sm:text-base text-sm  hover:text-white">
                    {item}
                  </li>
                );
              })}
